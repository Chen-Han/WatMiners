...
i.login(n,o)}}]).controller("DisplayCtrl",["$scope","$rootScope","$service","$state","$stateParams",function(n,o,a,e){a.rankings&&a.authData?(n.rankings=[],a.getRankings(function(o){console.log(o)
